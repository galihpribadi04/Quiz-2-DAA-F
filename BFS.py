...
print("\nMasukkan 9 digit angka yang akan diselesaikan dalam 8-puzzle (1 baris tanpa spasi)")
number = int(input())
print("\nNode yang telah dikunjungi:\n")
...
while Q:
	...
	for i in listing:
		if i[0] == 123456780:
			print("\nJumlah move = " + str(moves))
			print("Jumlah nodes yang di expand = " + str(nodes))
			exit(0)
		Q.append(i)